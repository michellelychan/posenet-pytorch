...
def draw_coordinates_to_image_file(appended_text, image_path, output_dir, output_stride, scale_factor, keypoint_scores, keypoint_coords, filename, displacements_fwd=None, displacements_bwd=None, include_displacements=False):
    ...
    keypoint_coords = keypoint_coords.clone()
    keypoint_coords = keypoint_coords.float()
    ...
    if include_displacements:
        ...
        plt.savefig(os.path.join(output_dir, f"displacements_{appended_text}_{filename}"), dpi=100)
    ...
    draw_image = posenet.draw_skel_and_kp(
        draw_image, instance_scores, keypoint_scores, keypoint_coords,
        min_pose_score=0.25, min_part_score=0.00001)
